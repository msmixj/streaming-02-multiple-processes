...
INPUT_FILE_NAME = "olympic_results.csv"
...
def prepare_message_from_row(row):
    ...
    Gender, Event, Location, Year, Medal, Name, Nationality, Result = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Gender}, {Event}, {Location}, {Year}, {Medal}, {Name}, {Nationality}, {Result}]"
